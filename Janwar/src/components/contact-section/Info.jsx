...
const contactDetails = [
  {
    value: 'National University of Computer and Emerging Sciences, Block B, Faisal Town, Lahore, Punjab, Pakistan.',
    icon: locationIcon,
  },
  { value: '+92 6798766759', icon: phoneIcon },
  { value: 'officialjanwar2024@gmail.com', icon: emailIcon },
]
